...
That is, each iteration, each individual is infected by a random individual in the population (includind themself).
...
In the case of a population of two people, there are possible outcomes when drawing who is infected by whom.
...
```{r, returningstrain}
set.seed(20200407)
many_sims <- replicate(300, full_sim(20, 30))
