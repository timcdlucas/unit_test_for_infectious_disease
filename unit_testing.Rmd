...
Models are a core part of infectious disease epidemiology and are increasingly computational rather than pen-and-paper mathematical.
Models of infectious diseases are used to guide policy that determine the health, morbidity or mortality of billions of people.
...
Examples include the models being used to directly advise govenments on responses to the COVID-19 pandemic [@ihme; @imperial; @hellewell2020feasibility] and [an_ntd_paper_that_definitely_influenced_policy].
