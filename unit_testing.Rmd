...
\newline
```{r first_code,  ref = "first_code", codecap = "Base example of the multi-strain re-infection model", results='hide'}
...
\newline
```{r, combine_simple_func, ref = "combine_simple_func", codecap = "Combine simple functions through nesting to check higher-level functionality", result = 'hide'}
