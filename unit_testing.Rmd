...
unit testing is a framework for doing this properly (@wickham2015r Chapter 7).
...
While there are a number of test functions, the main function is expect_equal and takes two arguments, the expression to run and the expected output.
So for our square root example above we would write expect_equal(sqrt(4), 2).
